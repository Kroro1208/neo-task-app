...
const ProjectsTopBar = () => {
    const { sideBar, mobileView, isDark, projectWindow } = useGlobalContextProvider();
  ...
  return (
    <div className={`${isDark ? "bg-blackColor" : "bg-white" }
      ...
      <div className='flex items-center gap-7'>
        ...
        className='text-[12px] bg-mainColor flex items-center p-2 px-4 gap-1 rounded-md text-white'>
